"""
Vercel Serverless Function: Instagram 프로필 스크래핑
i.instagram.com 내부 API를 사용하여 프로필 정보 + 최근 릴스 목록 추출
"""
...
def _scrape_instagram_profile(username: str) -> dict:
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        try:
            result = _scrape_instagram_profile(username)
            ...
            logger.exception("instagram handler error")
